        ...
        foreach ($params as $row) {
          ...
          foreach ($row as $key=>$value) {
            ...
            if (strpos($key, 'if_rows')===0) {
              ...
              $this->RowsIfRegion(array($key=>$value), $tpl_row);
              ...
              if ($first_row) {
                ...
                if ($this->m_columns===0) {
                  trigger_error('In rows you must specify index, starting from 1 eg.: '.$key.'[1]', E_USER_ERROR);
                  return false;            
                }                  
              }
        ...
        if (is_array($aRegion) ) {
          foreach ($aRegion as $key=>$value) {
            ...
            if ($region) {
              ...
              $this->RowsIfRegion( array($key=>$value), $this->m_row_tpl );
            }
