  				...
  				<table cellpadding="0" cellspacing="0" width="100%">
  					<tr>
  						<td style="border: 0px;" align="left">
  							<div class="image">
								...
								<a href="{address}[1]" target="_blank" title="Visit {address}[1]" onclick="visit_count({id}[1],'{home_url}');">
									<img src="{thumbnail_code_url}{address}[1]" title="Thumbnail for {address}[1]" border="0" alt="Thumbnail for {title}[1]">
  						...
  						<td style="border: 0px;" align="left" width="100%">
    						...
    						<p><span class="{url_disp}[1]">&raquo; Website: <a href="{address}[1]" target="_blank" title="Visit {address}[1]" onclick="visit_count({id}[1],'{home_url}');"><u>{address}[1]</u></a></span></p>
