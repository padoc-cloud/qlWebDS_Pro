...
/*
  ...
  - AddFooter
  - AddPagging // link: index.php5?costam=costam&amp;strona={nr}  <- most important {nr}
...
class GridClass {
      ...
      // check box
      var $m_chBoxColumnID = 'id';
      var $m_chBoxColumnName = '';
      var $m_isChbox = false;
      var $m_selectedChbox  = array();
      
      // delete link
      var $m_delColumnID = 'id';
      var $m_delColumnName = '';
      var $m_isDel = false;
      var $m_delAddr;
      ...
      // links
      var $m_links = array();
      var $m_linksHeaders = array();
      var $m_isLink = false;
      
      // form column
      var $m_isFColumn = false;
      var $m_FCIds = array();    // ID column name
      var $m_FCValues = array(); // value column name
      var $m_FCColumns = array();
      var $m_FCHeaders = array();
      ...
      function DefaultClasses() {
         ...
         $this->m_thClass = '';
         $this->m_trClass = array('tr_grid_a','tr_grid_b');
         $this->m_tdClass = '';
      ...
      function SetClasses($tableC,$thC, $trC,$tdC) {
         $this->m_class = $tableC;
         $this->m_thClass = $thC;
         $this->m_trClass = $trC;
         $this->m_tdClass = $tdC;
      ...
      function MakeQuery($view, $tables, $condition, $order, $page,$perpage) {
      ...
      function AddCheckbox($columnID, $columnName, $selected) {
      ...
      function AddDelete($columnID, $columnName, $addr) {
      ...
      function AddLink($columnID,  $linkTitle,  $addr) {

          // $this->m_columnsCount++;
          $addrAr = explode('{id}',$addr);
          $this->m_isLink = true;
          $this->m_links[] = array('ids'=>$columnID, 'title'=>$linkTitle, 'addr'=>$addrAr);
          // $this->m_links[] = array(  'ids'=>'m', 'title'=>'m', 'addr'=>'m');
          // array_push($this->m_linksHeaders ,$columnName);
      }
      
      function AddFCColumn($columnID, $columnValue, $columnType, $idPrfx, $colWidth) {
          $this->m_isFColumn = true;
          $this->m_columnsCount++;
          $this->m_FCIds[] = $columnID;
          $this->m_FCValues[] = $columnValue;
          $this->m_FCColumns[] = array('id'=>$columnID, 'value'=>$columnValue, 'type'=>$columnType, 'idpfx'=>$idPrfx, 'width'=>$colWidth);
          // array_push($this->m_FCHeaders ,$columnName);
      }

      function AddFormColumn($columnID, $columnValue, $columnType, $idPrfx, $colWidth) {
          $this->m_isFColumn = true;
          $this->m_columnsCount++;
          $this->m_FCIds[] = $columnID;
          $this->m_FCValues[] = $columnValue;
      ...
      function AddPagging($addr) { // example: index.php5?id=1&amp;page={nr}
          $tpl ='';
