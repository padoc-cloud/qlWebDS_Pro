...
class TemplateClass
{
    public $m_path       = '';
    public $m_tplt       = '';
    public $m_even_class = ' class="even" ';
    public $m_columns;
    public $m_row_tpl;
    ...
    public function FillRowsV2($region, $params, $add_brace = false)
    {
        ...
        $rep = ['{' . $region . '}' . $tpl_raw_row . '{/' . $region . '}' => $tpl_table];
        $this->ReplaceIn($rep);
        return true;

    }

    public function ReplaceIn($params)
    {
        $keys   = [];
        $values = [];
    ...
    public function RowsIfRegion($aRegion)
    {
    ...
    public function IfRegion($aRegion)
    {
    ...
    public function ReplaceArray($pattern, $params)
    {
        $tmp = '';
    ...
    public function Between($sFind, $eFind, $text)
    {
        $extract = false;
