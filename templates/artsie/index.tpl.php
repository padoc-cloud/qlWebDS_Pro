...
<table style="background-color:#036160">
 <tbody>
 <tr>
  <td style="background-color:#036160" colspan="3" align="center"><table><tr align="center"><td style="border:1px solid #CCC; text-align:center;" align="center">{top_block}</td></tr></table></td>
 </tr>
 <tr>
  <!-- Left //-->
  <td class="ql_left">
   ...
   <div class="buttonid">
      ...
      {end phone_search}
      				<!-- Random Site //-->
      				{if random_site==1}
      						<ul style="text-align: center; background-color:#fff;">
 ...
 <tr>
  ...
  <td colspan="3" class="ql_foot" align="center" style="color:#fff;">&nbsp; &copy; {year_foot} {company}. All Rights Reserved.{foot}{thumbnail_backlink}&nbsp;</td>
 </tr>
</tbody>
</table>
 </div>
