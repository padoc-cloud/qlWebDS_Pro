...
<table width="90%" cellpadding="0" cellspacing="10" align="center">
 <tbody>
 <tr>
  <td colspan="2">
	...
	<td class="topmenu" width="100%">
		...
		<tr>
		<td style="height: 77px; vertical-align: middle; color: #FFFFFF; padding-bottom: 10px;" align="center">{top_block}</td>
		</tr>
		</table>
		{if site_active==1}
		<table width="100%" style="background-color: #403931;" cellpadding="0">
		<tr>
			...
			<ul style="text-align: center;">
				...
				<div class="statistics" style="text-align: center;">
		  		<a href="{random_site_url}" target="_blank" title="Visit {random_site_url}">
					<img src="http://open.thumbshots.org/image.pxf?url={random_site_url}" style="border-color: #DC913E; border: 1px;" alt="Site Thumbnail for {random_site_url}">
				</a>
				<br>
