<?php 
  ...
  if ($g_user->Level() == AL_ADMIN) {
    ...
    $values = array('title'=>'', 'title1'=>'', 'title2'=>'', 'title3'=>'',
                    ...
                    'company'=>'', 'product'=>'', 'address'=>'', 'city'=>'', 'state'=>'','zip'=>'','country'=>'',
                    'tel'=>'','fax'=>'', 'exp_date'=>'', 'description_short'=>'', 'description'=>'',
					'facebook_url'=>'', 'twitter_url'=>'', 'youtube_url'=>'', 'embedded_video_title'=>'', 'embedded_video_code'=>'', 'reciprocal'=>'', 'keywords'=>'', 'link_type'=>'1', 'status'=>'');
	...
	// set template
    $g_template->SetTemplate(ADMIN_TEMPLATE_DIR.'admin_edit_listing.html');  
