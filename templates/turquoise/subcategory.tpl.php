<!-- This file was designed for the Turquoise Template //-->
<p>
		...
		<tr>
 			<td class="{featured/normal}[1]">
  				<table border="1" cellpadding="0" cellspacing="0" width="100%">
  					<tr>
  						<td style="border: 1px;" align="left">
  							<div class="image2">
  						...
  						<td style="border: 1px;" align="left" width="100%">
  						    <p class="{company_disp}[1]">&raquo; <b>{company}[1]</b></p>
