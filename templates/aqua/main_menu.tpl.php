...
{if latest_feat_links==1} 
	<div class="ql_last_featured">
		<ul style="margin: 0px;">
       		<li class="menu_top" style="background-image: url(templates/aqua/images/orange.gif); color: #CC6600; margin-bottom: 5px;">{lang latest_featured_links}</li>
       		<li style="border: 1px solid #DC913E; padding: 10px; margin: 0px; background-color: #F3D448;">  
	...
	<div class="ql_last">
   		<ul style="margin-top: 10px;">
    		<li class="menu_top" style="margin-bottom: 5px;">{lang latest_links}</li>
       		<li style="border: 1px solid #DDDDDD; padding: 10px; background-color: #EEEEEE;">  
				{row latest}
...
{end latest_links}
<br>
<div class="ql_right2" style="text-align: center;">
	{site_main_ads}
</div>
