...
<table class="sub_menu">
		<tr>
			<td style="border:1px groove #a3cfcf; background-color:#effdfd;">{subcategory}[1]</td>
			<td style="border:1px groove #a3cfcf; background-color:#effdfd;">{subcategory}[2]</td>
			<td style="border:1px groove #a3cfcf; background-color:#effdfd;">{subcategory}[3]</td>
		</tr>
</table>
{/row subcategories}
{admin foot menu}
