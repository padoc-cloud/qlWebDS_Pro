<!-- This file was designed for the Priceless Template //-->
<p>
...
<table class="sites" width="100%">
		<span class="{sort_disp}[1]"><tr><td class="{featured/normal}[1]">Sort by: {sort_by_date} :: {sort_by_name} :: {sort_by_title}</td></tr></span>
	{row site_first}
		<tr>
  				...
  				<table border="1" cellpadding="0" cellspacing="0" width="100%">
  					<tr>
  						...
  						<td style="border: 0px;" align="left" width="100%">
    						...
    						<span class="{url_disp}[1]"><p style="color: #23559C;">&raquo; Website: <a href="{address}[1]" target="_blank" title="Visit {address}[1]" onclick="visit_count({id}[1],'{home_url}');"><u>{address}[1]</u></a></p></span>
							...
							<p>{addr}[1]</p>
							<p>{city}[1] {state}[1] {zip}[1] &nbsp; <i>{country}[1]</i></p>
							</span>
