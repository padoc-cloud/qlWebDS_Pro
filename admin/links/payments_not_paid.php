<?php
  ...
  if ($g_user->Level() == AL_ADMIN) {
      ...
      $query = "SELECT COUNT(id) as hmany FROM $g_site->m_payment s WHERE paid=".PM_NOT_PAID;
      ...
      $query = "SELECT p.*, s.url FROM $g_site->m_payment p 
        ...
        WHERE p.paid=".PM_NOT_PAID.$order_by.$limit;
      ...
      $site_tpl['{lang payments}'] = LANG_PAYMENTS_NOT_PAID;
