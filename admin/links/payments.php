<?php
  ...
  if ($g_user->Level() == AL_ADMIN) {
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////////////////////
      // delete, make paid or not paid
      /////////////////////////////////////////////////////////////////////////////////////////////////////////////
  
      $payment_cbx = array();     
        
      if (isset($_POST['payment_cbx'])) {
          $payment_cbx = $_POST['payment_cbx']; 
      }
        
      if ( count($payment_cbx) ) {
          
        foreach ($payment_cbx as $key=>$value) {
          ...
          if ($rPayment) {
            ...
            } else if ( isset($_POST['submit_not_paid']) ) {
              
              $update['paid'] = PM_NOT_PAID;
              $g_site->UpdatePayment($update, $key);
              
            } else if ( isset($_POST['submit_del']) ) {              

              $g_site->DeletePayment($key);
	  ...
	  */
      ...
      foreach ($table as $payment ){
		...
		$payments[$i]['{site_url}'] = $payment['url'];
      ...
      $site_tpl['{lang payments}'] = LANG_ALL_PAYMENTS;
